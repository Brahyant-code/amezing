...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-7 col-xs-12 ">
                <div class="card" id="card">
                    <img id="Logo" src="../resources/iconosLogin/menup.jpg" alt="escaner QR">
                    <div class="card-body">
            ...
            <div class="col-md-1">
                <div><img id="vertical-line" src="../resources/iconosLogin/linea.png" alt=""></div>
            </div>
            <div class="col-md-4 col-xs-12">
                <form action="" method="POST" class="needs-validation" novalidate>
                    <div class="card" id="tarjeta">
                        <div class="card-body">
                            <center> <img id="imagenUser" src="../resources/iconosLogin/login.png" alt=""></center>
                            <br>
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <center><small>¿no tienes cuenta? <a href="../resources/views/registrar.php" id="linkCrear">Crea una</a></small></center>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <script src="../resources/js/validacionLogin.js"></script>
</body>
